...
namespace StateManagmentApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Data()
        {
            ...
            //capture data from Tempdata

            string dataReceived = TempData["userdetails"].ToString();
            Console.WriteLine("data received from Tempdata =" + dataReceived);
            //Rewrite data to ViewBag sothat we could show to View
            ViewBag.theData = dataReceived;
